...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        int studentID = 445052182; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        //feature 3:duisplay waiting time summary
        System.out.println("\nProcess summary :");
        for (Process process : processMap.values()) {
            System.out.println(" " + process.getName() + "Burst Time"+process.getBurstTime()+": Waiting Time = " + process.getWaitingTime() + " ms");
        }
